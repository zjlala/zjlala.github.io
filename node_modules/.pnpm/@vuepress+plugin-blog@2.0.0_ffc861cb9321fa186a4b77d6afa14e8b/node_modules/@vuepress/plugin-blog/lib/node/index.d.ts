...
import { PageExcerptOptions } from '@vuepress/helper';
...
interface BlogPluginOptions extends Pick<PageExcerptOptions, 'isCustomElement' | 'keepFenceDom' | 'keepPageTitle'> {
    /**
 ...
 * ```
 */
declare const blogPlugin: (options: BlogPluginOptions) => PluginFunction;
...
export { blogPlugin };
export type { BlogCategoryFrontmatterOptions, BlogCategoryOptions, BlogPluginCategoryFrontmatter, BlogPluginFrontmatter, BlogPluginOptions, BlogPluginPageData, BlogPluginTypeFrontmatter, BlogTypeFrontmatterOptions, BlogTypeOptions, CategoriesMap, CategoryConfig, CategoryLocaleConfig, CategoryLocaleMap, CategoryMap, TypeLocaleConfig, TypeMap, TypesMap };
